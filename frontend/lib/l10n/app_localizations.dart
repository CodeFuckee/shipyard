...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'The backend LLM is not configured. Add an AI provider with an API Key (the default provider is preferred), or set HERMES_BASE_URL on the deployment to point to the bundled hermes.'**
